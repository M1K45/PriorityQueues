...
/*
    FUNKCJE POMIAROWE DLA OPERACJI PEEK
*/
void ArrayPeekMeasure(int measuringPoint)
{
    // 10 instancji
    ...
    std::cout << "wykonywanie operacji peek dla kolejki opratej na tablicy, dla " << measuringPoint << " elementow\n";

    file.open("pomiary_tablica.csv", std::ios::app);
    file << "Czasy wykonania operacji peek dla kolejki opartej na tablicy, dla punktu pomierowego: " << measuringPoint << std::endl;
...
void HeapPeekMeasure(int measuringPoint)
{
    // 10 instancji
    ...
    double srednia = 0;
    std::ofstream file;
    std::cout << "wykonywanie operacji peek dla kolejki opratej na kopcu, dla " << measuringPoint << " elementow\n";

    file.open("pomiary_kopiec.csv", std::ios::app);
    file << "Czasy wykonania operacji peek dla kolejki opartej na kopcu, dla punktu pomierowego: " << measuringPoint << std::endl;
