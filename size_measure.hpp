...
/*
    FUNKCJE POMIAROWE DLA OPERACJI SIZE
*/
void ArraySizeMeasure(int measuringPoint)
{
    // 10 instancji
    ...
    double srednia = 0;
    std::ofstream file;
    std::cout << "wykonywanie operacji size dla kolejki opratej na tablicy, dla " << measuringPoint << " elementow\n";

    file.open("pomiary_tablica.csv", std::ios::app);
    file << "Czasy wykonania operacji size dla kolejki opartej na tablicy, dla punktu pomierowego: " << measuringPoint << std::endl;
...
void HeapSizeMeasure(int measuringPoint)
{
    // 10 instancji
    ...
    double srednia = 0;
    std::ofstream file;
    std::cout << "wykonywanie operacji size dla kolejki opratej na kopcu, dla " << measuringPoint << " elementow\n";

    file.open("pomiary_kopiec.csv", std::ios::app);
    file << "Czasy wykonania operacji size dla kolejki opartej na kopcu, dla punktu pomierowego: " << measuringPoint << std::endl;
